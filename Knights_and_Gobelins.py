...
class Case :
    ...
    def evenementactive(self, joueur,Liste_Case):
        ...
        if self.numero <= 7 :
            #print("sur Donjon")
            y = -800
            g = pygame.image.load('Donjon/Donjon 32.png').convert_alpha()
            Screen.blit(g,(0,y))
            for i in range (0,16) :
                y += 50
                refresh_plateau()
        ...
        if 7 < self.numero <= 15 :
            #print("sur Village")
            pygame.time.wait(useless_wait_var)
        ##Sanctuaire
...
class Rain(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = []
        self.images.append(pygame.image.load('Menu/Pluie/Pluie 4.png').convert_alpha())
        self.images.append(pygame.image.load('Menu/Pluie/Pluie 5.png').convert_alpha())
        self.images.append(pygame.image.load('Menu/Pluie/Pluie 6.png').convert_alpha())
        self.images.append(pygame.image.load('Menu/Pluie/Pluie 7.png').convert_alpha())
        self.images.append(pygame.image.load('Menu/Pluie/Pluie 8.png').convert_alpha())
        self.images.append(pygame.image.load('Menu/Pluie/Pluie 9.png').convert_alpha())
        self.index = 0
...
class Sanctuaire(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = []
        self.images.append(pygame.image.load('Sanctuaire/sword 1.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 2.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 3.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 4.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 5.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 6.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 7.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 8.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 9.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 10.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 11.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 12.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 13.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 14.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 15.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 16.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 17.png').convert_alpha())
        self.images.append(pygame.image.load('Sanctuaire/sword 18.png').convert_alpha())
        self.index = 0
        self.image = self.images[self.index]
        self.rect = pygame.Rect(5,5,150,198)
    def update(self):
    ...
    while game == True :
        for event in pygame.event.get() :
            ...
            if event.type == KEYDOWN :
                ...
                if event.unicode == 'q' and not Touche1J1 :
                    #print('J1 Touche 1')
                    Touche1J1 = True
                if event.unicode == 's' and not Touche2J1 :
                   #print('J1 Touche 2')
                    Touche2J1 = True
                if event.unicode == 'g' and not Touche1J2 :
                   #print('J2 Touche 1')
                    Touche1J2 = True
                if event.unicode == 'h' and not Touche2J2 :
                   #print('J2 Touche 2')
                    Touche2J2 = True
                if nb_joueur >= 3 :
                    if event.unicode == 'k' and not Touche1J3 :
                       #print('J3 Touche 1')
                        Touche1J3 = True
                    if event.unicode == 'l' and not Touche2J3 :
                       #print('J3 Touche 2')
                        Touche2J3 = True
                if nb_joueur == 4 :
...
def Cowboy():
    J1_Push = False
    J2_Push = False
    back = pygame.image.load('mini/cowboy/crprov.png')
    Screen.blit(back,(0,0))
    CaR = 3250
    clock.tick(tick_rate)
    pygame.display.update()
    pygame.time.wait(CaR)
    back = pygame.image.load('mini/cowboy/cr7.png')
    Screen.blit(back,(0,0))
    CaRi = pygame.image.load('mini/cowboy/cr3.png')
    ...
    back = pygame.image.load('mini/cowboy/cr7.png')
    Screen.blit(back,(0,0))
    CaRi = pygame.image.load('mini/cowboy/cr2.png')
    Screen.blit(CaRi,(0,0))
    clock.tick(tick_rate)
    pygame.display.update()
    pygame.time.wait(850)
    back = pygame.image.load('mini/cowboy/cr7.png')
    Screen.blit(back,(0,0))
    CaRi = pygame.image.load('mini/cowboy/cr1.png')
    Screen.blit(CaRi,(0,0))
    clock.tick(tick_rate)
    pygame.display.update()
    pygame.time.wait(850)
    back = pygame.image.load('mini/cowboy/cr7.png')
    Screen.blit(back,(0,0))
    CaRi = pygame.image.load('mini/cowboy/cr7goat.png')
    Screen.blit(CaRi,(0,0))
    clock.tick(tick_rate)
    pygame.display.update()
    pygame.time.wait(850)
    ...
    if int(Temp_J2) > int(Temp_J1) :
       #print("J2 win")
        ...
        CaRi = pygame.image.load('mini/cowboy/cictoireJ2.png')
        Screen.blit(CaRi,(0,0))
        clock.tick(tick_rate)
        pygame.display.update()
        pygame.time.wait(3000)
       ...
       #print("J1 win")
        ...
        CaRi = pygame.image.load('mini/cowboy/cictoireJ1.png')
        Screen.blit(CaRi,(0,0))
        clock.tick(tick_rate)
        pygame.display.update()
        pygame.time.wait(3000)
       ...
       #print("Tie !")
        CaRi = pygame.image.load('mini/cowboy/ctie.png')
        Screen.blit(CaRi,(0,0))
        clock.tick(tick_rate)
        pygame.display.update()
        pygame.time.wait(3000)
...
def gameloop(Liste_Case, nb_joueur, symbolJ1 , symbolJ2, symbolJ3 , symbolJ4,currentplayer, action) :
    ...
    while not GameExit :
        ...
        if currentplayer == 1 :
            ...
            if action[0] == False  :
                refresh_plateau()
                HUDDebut = pygame.image.load('HUD/J1 - Begin.png').convert_alpha()
            ...
            if action[0] == True :
                ...
                if event.type == KEYDOWN :
                    keymap[event.scancode] = event.unicode
                    if event.unicode == 'a' and Liste_Joueur[currentplayer - 1].mort == False  :
                        actual_dice = dice()
        ...
        if currentplayer == 2 :
            ...
            if action[0] == False :
                refresh_plateau()
                HUDDebut = pygame.image.load('HUD/J2 - Begin.png').convert_alpha()
                Screen.blit(HUDDebut,(0,0))
                for event in pygame.event.get() :
                    if event.type == KEYDOWN :
                        if event.key == pygame.K_SPACE:
        ...
        if currentplayer == 3 :
            ...
            if action[0] == False :
                refresh_plateau()
                HUDDebut = pygame.image.load('HUD/J3 - Begin.png').convert_alpha()
                Screen.blit(HUDDebut,(0,0))
                for event in pygame.event.get() :
                    if event.type == KEYDOWN :
                        if event.key == pygame.K_SPACE:
        ...
        if currentplayer == 4 :
            ...
            if action[0] == False :
                refresh_plateau()
                HUDDebut = pygame.image.load('HUD/J4 - Begin.png').convert_alpha()
                Screen.blit(HUDDebut,(0,0))
                for event in pygame.event.get() :
                    if event.type == KEYDOWN :
                        if event.key == pygame.K_SPACE:
...
def selec_joueur(Liste_Case,nb_joueur,symbolJ1 , symbolJ2, symbolJ3 , symbolJ4) :
    ...
    while not SelecMenu :
        ...
        #Affichage Mode
        if nb_joueur == 2 :
            BackgroundSelecJoueur = pygame.image.load('Menu/Selection/Mode 2J.png').convert_alpha()
            Screen.blit(BackgroundSelecJoueur,(0,0))
        if nb_joueur == 3 :
            BackgroundSelecJoueur = pygame.image.load('Menu/Selection/Mode 3J.png').convert_alpha()
            Screen.blit(BackgroundSelecJoueur,(0,0))
        if nb_joueur == 4 :
            BackgroundSelecJoueur = pygame.image.load('Menu/Selection/Mode 4J.png').convert_alpha()
            Screen.blit(BackgroundSelecJoueur,(0,0))
    #Affichage Pion
        #J1
        if symbolJ1 == 1 :
            pion = pygame.image.load('Pion/Jaune Shield.png').convert_alpha()
            Screen.blit(pion,(185,269))
        if symbolJ1 == 2 :
            pion = pygame.image.load('Pion/Jaune Bow.png').convert_alpha()
            Screen.blit(pion,(185,269))
        if symbolJ1 == 3 :
            pion = pygame.image.load('Pion/Jaune Sword.png').convert_alpha()
            Screen.blit(pion,(185,269))
        if symbolJ1 == 4 :
            pion = pygame.image.load('Pion/Jaune Wizard.png').convert_alpha()
            Screen.blit(pion,(185,269))
        #J2
        if symbolJ2 == 1 :
            pion = pygame.image.load('Pion/Bleu Shield.png').convert_alpha()
            Screen.blit(pion,(185,353))
        if symbolJ2 == 2 :
            pion = pygame.image.load('Pion/Bleu Bow.png').convert_alpha()
            Screen.blit(pion,(185,353))
        if symbolJ2 == 3 :
            pion = pygame.image.load('Pion/Bleu Sword.png').convert_alpha()
            Screen.blit(pion,(185,353))
        if symbolJ2 == 4 :
            pion = pygame.image.load('Pion/Bleu Wizard.png').convert_alpha()
            Screen.blit(pion,(185,353))
        #J3
        if nb_joueur >= 3 :
            if symbolJ3 == 1 :
                pion = pygame.image.load('Pion/Violet Shield.png').convert_alpha()
                Screen.blit(pion,(185,423))
            if symbolJ3 == 2 :
                pion = pygame.image.load('Pion/Violet Bow.png').convert_alpha()
                Screen.blit(pion,(185,423))
            if symbolJ3 == 3 :
                pion = pygame.image.load('Pion/Violet Sword.png').convert_alpha()
                Screen.blit(pion,(185,423))
            if symbolJ3 == 4 :
                pion = pygame.image.load('Pion/Violet Wizard.png').convert_alpha()
                Screen.blit(pion,(185,423))
        #J4
        if nb_joueur == 4 :
            if symbolJ4 == 1 :
                pion = pygame.image.load('Pion/Vert Shield.png').convert_alpha()
                Screen.blit(pion,(185,490))
            if symbolJ4 == 2 :
                pion = pygame.image.load('Pion/Vert Bow.png').convert_alpha()
                Screen.blit(pion,(185,490))
            if symbolJ4 == 3 :
                pion = pygame.image.load('Pion/Vert Sword.png').convert_alpha()
                Screen.blit(pion,(185,490))
            if symbolJ4 == 4 :
                pion = pygame.image.load('Pion/Vert Wizard.png').convert_alpha()
                Screen.blit(pion,(185,490))
        next = pygame.image.load('Menu/Selection/Appuyer sur Espace.png').convert_alpha()
            ...
            if event.type == pygame.MOUSEBUTTONUP :
                ...
                if 600 < x < 930 and 650 < y < 777 :
                   ...
                   #print('Regles')
                    selec_joueur(Liste_Case, nb_joueur,symbolJ1 , symbolJ2, symbolJ3 , symbolJ4)
                    MenuAnim = True
        TitleBackground = pygame.image.load("Menu/Title Screen - Background.png").convert_alpha()
        Screen.blit(TitleBackground,(0,0))
        groupe_de_pluie.update()
        groupe_de_pluie.draw(Screen)
        Buttons = pygame.image.load('Menu/Title Screen - Buttons.png').convert_alpha()
        Screen.blit(Buttons,(0,0))
        Title = pygame.image.load('Menu/Title Screen - Title.png').convert_alpha()
